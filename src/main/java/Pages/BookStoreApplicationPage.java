...
public class BookStoreApplicationPage extends BasePage {
    ...
    private static final By BOOK_STORE_APPLICATION_LOCATOR=By.xpath("(\"//div[@id='app']/div/div/div[2]/div/div[6]/div/div[3]/h5\")).click();");
    private static final By VERIFY_TITLE_LOCATOR_OF_THIRD_BOOK=By.xpath("/*[@id=\\\"see-book-Designing Evolvable Web APIs with ASP.NET\\\"]/a\")");
    private static final By VERIFY_AUTHOR_LOCATOR_OF_THIRD_BOOK=By.xpath("//*[@id=\"app\"]/div/div/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div[3]/div/div[3]");
    private static final By VERIFY_PUBLISHER_LOCATOR_OF_THIRD_BOOK=By.xpath("//*[@id=\"app\"]/div/div/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div[3]/div/div[4]");
